<?php
class Model_PenjualanProdukKasir extends CI_Model
{
	...
	var $column_search = array('pjlc_id', 'pjlc_tgl', 'pjlc_no_faktur', 'pjlc_plgc_id'); //set column field database for datatable searchable just firstname , lastname , address are searchable
	...
	private function _get_datatables_query() 
	{
		...
		$this->db->join("kspb_pelanggan", "plgc_id = pjlc_plgc_id", "left");
		$i = 0;
