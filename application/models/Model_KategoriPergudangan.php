<?php
  class Model_KategoriPergudangan extends CI_Model {
  
  	var $table = 'gdgs_kategori';
	var $column_order = array('ktg_nama'); //set column field database for datatable orderable
	var $column_search = array('ktg_nama'); //set column field database for datatable searchable just firstname , lastname , address are searchable
	var $order = array('ktg_nama' => 'asc'); // default order  	private $db_sts;
