	...
	<div class="row">
		<div class="col-md-2 col-xs-12">
			<div class="form-group">
				<a href="#" class="btn btn-success btn-block" id="ktg_tambah"><i class="fa fa-plus"></i> &nbsp;&nbsp;&nbsp; Tambah Data</a>
			</div>
		</div>
		<div class="col-md-2 col-xs-12">
			<div class="form-group">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title"><i class="glyphicon glyphicon-info"></i> Form Kategori</h3>
			</div>
			<form role="form  col-lg-6" name="Kategori" id="frm_kategori">
				<div class="modal-body form">
					<div class="alert alert-danger" style="display:none; list-style-type: none;"></div>
					<div class="row">
						<input type="hidden" id="ktg_id" name="ktg_id" value="">
						<div class="col-lg-12">
							<div class="form-group">
								<label>Nama</label>
								<input type="text" class="form-control" name="ktg_nama" id="ktg_nama" placeholder="Nama" value="">
							</div>
						</div>
					</div>
				</div>
				<div class="modal-footer">
					<button type="submit" id="ktg_simpan" class="btn btn-success">Simpan</a>
...
<script>
	...
	$("#frm_kategori").submit(function(e) {
		// var dataString = $("#frm_kategori").serialize();
		e.preventDefault();
		$("#ktg_simpan").html("Menyimpan...");
	...
	function ubah_kategori(id) {
		...
		$.ajax({
			...
			success: function(data) {
				...
				// $("#ktg_id").val(data.ktg_id);
				// $("#ktg_nama").val(data.ktg_nama);
				// $("#ktg_alamat").val(data.ktg_alamat);
				// $("#ktg_telp").val(data.ktg_telp);
