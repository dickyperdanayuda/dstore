		...
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body table-responsive">
					<table class="table table-striped table-bordered table-hover" id="tabel-pengeluaran" width="100%" style="font-size:120%;">
						<thead>
							<tr>
								<th>No</th>
								<th>Tanggal</th>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title"><i class="glyphicon glyphicon-info"></i> Form Pengeluaran</h3>
			</div>
			<form role="form  col-lg-6" name="Pengeluaran" id="frm_pengeluaran">
				<div class="modal-body form">
					<div class="row">
						<input type="hidden" id="klr_id" name="klr_id" value="">

						<div class="col-lg-6">
							<div class="form-group">
								<label>Tanggal</label>
								<input type="text" class="form-control tgl" name="klr_tgl" id="klr_tgl" placeholder="" required>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<label>Jumlah</label>
								<input type="number" min="0" class="form-control" name="klr_jml" id="klr_jml" placeholder="" required>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group">
								<label>Keperluan</label>
								<input type="text" class="form-control" name="klr_keperluan" id="klr_keperluan" placeholder="" required>
							</div>
						</div>
					</div>
				</div>
				<div class="modal-footer">
					<button type="submit" id="klr_simpan" class="btn btn-dark">Simpan</button>
