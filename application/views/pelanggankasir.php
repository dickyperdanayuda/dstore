		...
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body table-responsive">
					<table class="table table-striped table-bordered table-hover" id="tabel-pelanggan" width="100%" style="font-size:120%;">
						<thead>
							<tr>
								<th>No</th>
								<th>Nama</th>
...
<div class="modal fade" id="modal_pelanggan" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form role="form  col-lg-6" name="Pelanggan" id="frm_pelanggan">
				<div class="modal-body form">
					<div class="row">
						<input type="hidden" id="plgc_id" name="plgc_id" value="">

						<div class="col-lg-6">
							<div class="form-group">
								<label>Nama Pelanggan</label>
								<input type="text" class="form-control" name="plgc_nama" id="plgc_nama" placeholder="" required>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<label>Telepon</label>
								<input type="text" class="form-control" name="plgc_telp" id="plgc_telp" placeholder="" required>
							</div>
						</div><div class="col-lg-6">
							<div class="form-group">
								<label>Alamat</label>
								<input type="text" class="form-control" name="plgc_alamat" id="plgc_alamat" placeholder="" required>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<label>Tanggal Bergabung</label>
								<input type="text" class="form-control tgl" name="plgc_tgl_bergabung" id="plgc_tgl_bergabung" placeholder="" required>
							</div>
						</div>
...
<script>
	...
	$("#frm_pelanggan").submit(function(e) {
		e.preventDefault();
