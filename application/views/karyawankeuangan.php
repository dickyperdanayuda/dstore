		...
		<div class="modal-content">
			...
			<form role="form  col-lg-6" name="Karyawan" id="frm_karyawan">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="kry_nama" id="kry_nama" placeholder="" required>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label>Telpon</label>
								<input type="number" min="0" class="form-control" name="kry_telp" id="kry_telp" placeholder="" required>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label>Jabatan</label>
								<select class="form-control" name="kry_jab_id" id="kry_jab_id">
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<select class="form-control" name="kry_jenis_gaji" id="kry_jenis_gaji">
				...
				<div class="modal-footer">
					<button type="submit" id="kry_simpan" class="btn btn-dark">Simpan</button>
