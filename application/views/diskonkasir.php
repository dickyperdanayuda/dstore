		...
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body table-responsive">
					<table class="table table-striped table-bordered table-hover" id="tabel-diskon" width="100%" style="font-size:120%;">
						<thead>
							<tr>
								<th>No</th>
...
<!-- Bootstrap modal -->
<div class="modal fade" id="modal_diskon" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title"><i class="glyphicon glyphicon-info"></i> Form Diskon</h3>
			</div>
			<form role="form  col-lg-6" name="Pelanggan" id="frm_diskon">
				<div class="modal-body form">
					<div class="row">
						<input type="hidden" id="dspl_id" name="dspl_id" value="">
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<select class="form-control" required name="dspl_jenis" id="dspl_jenis">
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label>Jumlah</label>
								<input type="text" class="form-control" name="dspl_jml" id="dspl_jml" placeholder="" required>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<label>Status</label>
								<select class="form-control" required name="dspl_status" id="dspl_status">
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="dspl_keterangan" id="dspl_keterangan" placeholder="" required>
							</div>
						</div>
